...
if ((KPCF_activeStorage distance2D KPCF_activeSpawn) > GVAR(crateFillerTargetDistance)) exitWith {
...
if (!((typeOf KPCF_activeStorage) in GVAR(crateFillerCrates))) exitWith {
