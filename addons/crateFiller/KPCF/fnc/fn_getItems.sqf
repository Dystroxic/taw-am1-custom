...
// Black & whitelisting
_classNames = _classNames - EGVAR(arsenal,globalBlacklist);
...
// Sort the item lists
diag_log "CRATE sorting crates";
KPCF_sortedCrates = [GVAR(availableCrates)] call KPCF_fnc_sortList;
diag_log "CRATE sorting weap";
KPCF_sortedWeapons = [KPCF_weapons] call KPCF_fnc_sortList;
diag_log "CRATE sorting gren";
KPCF_sortedGrenades = [KPCF_grenades] call KPCF_fnc_sortList;
diag_log "CRATE sorting expl";
KPCF_sortedExplosives = [KPCF_explosives] call KPCF_fnc_sortList;
diag_log "CRATE sorting items";
KPCF_sortedItems = [KPCF_items] call KPCF_fnc_sortList;
diag_log "CRATE sorting back";
